-- ═══════════════════════════════════════════════════════════════════
--  HomeFlow — Database Migration 001: Initial Schema
-- ═══════════════════════════════════════════════════════════════════
--
--  Run against the extropy_engine database.
--  The application also auto-creates these tables on startup,
--  but this file is provided for explicit migration workflows.
--
-- ═══════════════════════════════════════════════════════════════════
